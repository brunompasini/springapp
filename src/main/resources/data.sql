...
INSERT INTO HEATER(id, status, name, power, room_id) VALUES(-10, 'ON', 'Heater1', 2000, -10);
INSERT INTO HEATER(id, status, name, power, room_id) VALUES(-9, 'ON', 'Heater2', null, -10);
